    ...
    border border-gray-200 space-y-6 p-4">
        <form method="POST" action="/register">
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{old('name')}}" name="name" id="name" placeholder="username" class="w-full border border-gray-300 py-2 pl-3 rounded mt-2 outline-none focus:ring-indigo-600 :ring-indigo-600" />
                @error('name')
